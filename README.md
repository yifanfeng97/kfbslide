...
|------|----------------|-----------------|--------|
| 单区域 512×512 | 5.74 ms | 7.65 ms | **1.33×** |
| 单区域 1024×1024 | 16.97 ms | 30.23 ms | **1.78×** |
| 连续扫描 100 tiles | 74.65 ms | 186.62 ms | **2.50×** |
| 随机访问 100 tiles | 264.76 ms | 322.70 ms | **1.22×** |
| Level 1 256×256 | 2.52 ms | 8.02 ms | **3.19×** |
| 缓存命中 256×256 | 0.27 ms | 1.81 ms | **6.70×** |
