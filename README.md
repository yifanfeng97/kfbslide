...
|------|----------------|-----------------|--------|
| 缓存命中 512×512 | 0.89 ms | 7.35 ms | **8.26×** |
| 单区域 512×512 | 5.81 ms | 7.80 ms | **1.34×** |
| 单区域 1024×1024 | 16.81 ms | 29.93 ms | **1.78×** |
| 连续扫描 100 tiles | 297.48 ms | 846.10 ms | **2.84×** |
| 随机访问 100 tiles | 604.17 ms | 1051.36 ms | **1.74×** |
